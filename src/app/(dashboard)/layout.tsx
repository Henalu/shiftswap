  ...
  return (
    ...
    >
      <Header
        ...
        role={role}
      />
      <div className="flex min-h-0 min-w-0 w-full flex-1 overflow-x-hidden pt-[calc(env(safe-area-inset-top)+3.5rem)] md:pt-0">
        ...
        <TransientScrollbarMain className="min-h-0 min-w-0 flex-1 overflow-x-hidden overflow-y-auto">
          <div className="mx-auto flex min-h-full w-full max-w-[1600px] flex-col gap-8 px-4 py-6 pb-[calc(env(safe-area-inset-bottom)+7rem)] sm:px-6 md:pb-6 lg:px-8 2xl:px-10">
