...
-- Requires migration 00020_department_hierarchy.sql
...
BEGIN
  ...
  IF v_aceria_ldg_id IS NULL THEN
    INSERT INTO public.departments (company_id, name, parent_department_id, created_at)
    VALUES (v_company_id, U&'Acer\00EDa LDG', NULL, NOW())
  ...
  IF v_department_id IS NULL THEN
    INSERT INTO public.departments (company_id, name, parent_department_id, created_at)
    VALUES (v_company_id, 'Carril', NULL, NOW());
  ELSE
    UPDATE public.departments
    SET parent_department_id = NULL
  ...
  IF v_department_id IS NULL THEN
    INSERT INTO public.departments (company_id, name, parent_department_id, created_at)
    VALUES (v_company_id, U&'Alambr\00F3n', NULL, NOW());
  ELSE
    UPDATE public.departments
    SET parent_department_id = NULL
    WHERE id = v_department_id;
  ...
  IF v_department_id IS NULL THEN
    INSERT INTO public.departments (company_id, name, parent_department_id, created_at)
    VALUES (v_company_id, 'Otros', NULL, NOW());
  ELSE
    UPDATE public.departments
    SET parent_department_id = NULL
    WHERE id = v_department_id;
  ...
  IF v_department_id IS NULL THEN
    INSERT INTO public.departments (company_id, name, parent_department_id, created_at)
    VALUES (v_company_id, U&'Producci\00F3n', v_aceria_ldg_id, NOW());
  ELSE
    UPDATE public.departments
  ...
  IF v_department_id IS NULL THEN
    INSERT INTO public.departments (company_id, name, parent_department_id, created_at)
    VALUES (v_company_id, U&'M\00E1quinas', v_aceria_ldg_id, NOW());
  ELSE
    UPDATE public.departments
    SET parent_department_id = v_aceria_ldg_id
    WHERE id = v_department_id;
  ...
  IF v_department_id IS NULL THEN
    INSERT INTO public.departments (company_id, name, parent_department_id, created_at)
    VALUES (v_company_id, U&'Mantenimiento mec\00E1nico', v_aceria_ldg_id, NOW());
  ELSE
    UPDATE public.departments
    SET parent_department_id = v_aceria_ldg_id
    WHERE id = v_department_id;
  ...
  IF v_department_id IS NULL THEN
    INSERT INTO public.departments (company_id, name, parent_department_id, created_at)
    VALUES (v_company_id, U&'Mantenimiento el\00E9ctrico', v_aceria_ldg_id, NOW());
  ELSE
    UPDATE public.departments
    SET parent_department_id = v_aceria_ldg_id
    WHERE id = v_department_id;
