-- Migration 00034: repair exchange slot exclusivity for environments that already applied the previous draft.

DROP INDEX IF EXISTS public.idx_shift_requests_unique_active_compensation_reservation;
DROP INDEX IF EXISTS public.idx_exchanges_unique_active_shift;
DROP INDEX IF EXISTS public.idx_exchanges_unique_active_compensation_slot;
